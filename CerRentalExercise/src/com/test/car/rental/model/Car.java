...
public class Car extends Vehicle {
	...
	public Car(String model, String number, int capacity, String ambiance, String fuelType) {
	...
	@Override
	public double acceptBooking(Booking booking) throws InvalidDataException {
		double distance = 0;
		double rent = Constants.STANDARD_RATE;
		if(Constants.DIESEL.equalsIgnoreCase(booking.getFuelType())){
			rent =  rent - 1;
		}
